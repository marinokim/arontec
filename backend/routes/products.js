...
router.post('/', requireAdmin, async (req, res) => {
    try {
       ...
       RETURNING *`,
            [categoryId, brand, modelName, description, cleanImageUrl, b2bPrice, stockQuantity, detailUrl, isAvailable !== undefined ? isAvailable : true, consumerPrice, supplyPrice, quantityPerCarton, manufacturer, origin, isTaxFree || false, shippingFeeIndividual || 0, shippingFeeCarton || 0, productOptions || '', modelNo || '', remarks || '', displayOrder || 0, productSpec || '', isNew || false]
        )
...
router.put('/:id', requireAdmin, async (req, res) => {
    try {
       ...
       WHERE id = $24
       RETURNING *`,
            [categoryId, brand, modelName, description, cleanImageUrl, b2bPrice, stockQuantity, isAvailable, detailUrl, consumerPrice, supplyPrice, quantityPerCarton, manufacturer, origin, isTaxFree, shippingFeeIndividual, shippingFeeCarton, productOptions, modelNo, remarks, displayOrder || 0, productSpec || '', isNew !== undefined ? isNew : false, req.params.id]
        )
